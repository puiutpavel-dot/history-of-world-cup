...
Jucătorul alege o ediție a Cupei Mondiale (1930-2022) și o națională disponibilă în acea eră. Echipa primește un lot generat de 18 jucători, cu rating calculat dintr-o curbă istorică de putere per echipă/an — iar fotbaliștii legendari reali (Pelé, Maradona, Beckenbauer, Cruyff, Zidane, Messi ș.a.) apar automat în lotul echipei lor, la anul corect.
...
- Structura de date (REAL_FIXTURES, TEAMS.curve) e identică cu planul original, deci oricine poate extinde subsetul de meciuri reale fără nicio schimbare de motor.
...
1. Extinde real_fixtures.js cu mai multe campanii/ediții (structura suportă orice număr de chei ECHIPA_AN).
